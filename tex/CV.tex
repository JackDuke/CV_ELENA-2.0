...
\begin{minipage}{0.3\textwidth}
	\includegraphics[scale=0.045]{../imgs/profile.jpg}
\end{minipage}
\begin{minipage}{0.5\textwidth}
	\textbf{\Huge \scshape{Elena Ceccarelli}}
	\begin{itemize}[leftmargin=*]
		\item[\faMapMarker] \small{Via Montebasso 12, Fiano (TO), 10070}
		\item[\faPhone] +39 3456791137
		\item[\faEnvelope] elececca99@gmail.com
		\item[\faGift] 30/11/1999
		\item[\faCar] categoria B
	\end{itemize}
\end{minipage}

%-----EDUCATION-------------------------%
\section{\textbf{Profilo}}
